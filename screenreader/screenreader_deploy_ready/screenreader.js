 ...
 * and ; to go upto previous punctuation mark
 ...
 * converts into
 * speech. i also have a platform independent one also
 *The server app (browserspeak.exe) is not mine fully. but i modified and added feautures for changing 
 *voices and volume, rate controls and a save webpage 'hack'
